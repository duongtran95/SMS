...
public class ContactsWrapper3 extends ContactsWrapper {

    //Tag
    private static String TAG = "cw3";

    //Selection for getting link Contact from number.
    private static String CALLER_ID_SELECTION = "PHONE_NUMBERS_EQUAL(" + PhonesColumns.NUMBER + ",?)";

    //link Uri for getting link Contact from number.
    private static Uri PHONES_WITH_PRESENCE_URI = Uri.parse(Phones.CONTENT_URI + "_with_presence");

    //Projection for getting link Contact from number.
    private static String[] CALLER_ID_PROJECTION = new String[]{PhonesColumns.NUMBER, // 0
    ...
    //link Uri for getting link Contact from number.
    private static Uri PHONES_WITHOUT_PRESENCE_URI = Phones.CONTENT_URI;

    //Projection for getting link Contact from number.
    private static String[] CALLER_ID_PROJECTION_WITHOUT_PRESENCE = new String[]{
    ...
    private static int INDEX_CALLER_ID_NUMBER = 0;

    //Index in CALLER_ID_PROJECTION: name.
    private static int INDEX_CALLER_ID_NAME = 1;

    //Index in CALLER_ID_PROJECTION: id.
    private static int INDEX_CALLER_ID_CONTACTID = 2;

    //Index in CALLER_ID_PROJECTION: presence.
    private static int INDEX_CALLER_ID_PRESENCE = 3;

    //Projection for persons query, filter.
    private static String[] PROJECTION_FILTER = new String[]{Extensions.PERSON_ID, // 0
            PeopleColumns.NAME, // 1
    ...
    private static String[] PROJECTION_CONTENT = new String[]{BaseColumns._ID, // 0
            PeopleColumns.NAME, // 1
            PhonesColumns.NUMBER, // 2
            PhonesColumns.TYPE // 3
    };
    ...
    private static String MOBILES_ONLY = PhonesColumns.TYPE + " = "
            + PhonesColumns.TYPE_MOBILE;

    ///Sort Order.
    private static String SORT_ORDER = PeopleColumns.STARRED + " DESC, "
